...
function cadastrarRegistro() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('title_modal').className = 'modal-title text-success'
        document.getElementById('conteudo_modal').innerHTML = 'Os dados foram cadastrados com sucesso'
        ...
        document.getElementById('title_modal').className = 'modal-title text-danger'
        document.getElementById('conteudo_modal').innerHTML = 'Os dados não foram cadas'
